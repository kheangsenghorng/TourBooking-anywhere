    ...
    <main className="min-h-screen">
      ...
      <section className="bg-green-700 text-white py-12 px-6 flex flex-col md:flex-row items-center justify-center gap-8">
        ...
        <div className="max-w-md text-center md:text-left">
          <p className="text-sm md:text-base">
            Helping users make informed decisions while supporting media providers by giving them a platform to showcase
            their expertise.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="space-y-4">
            <p className="text-sm">
              Our mission is simple: to provide a seamless experience for users to search, compare, and choose the best
              services based on genuine user experiences and expert recommendations. We believe in creating a platform
              that connects users with providers while supporting service providers by giving them a platform to
      ...
      <section className="py-12 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-4 order-1 md:order-2">
            <p className="text-sm">
              At Travel With Us, we aim to make finding the perfect travel experiences easy and enjoyable. Our platform
              is designed to be user-friendly, transparent, and platform-ready to make range of service categories to
              meet all your travel needs, all while you enjoy a straightforward journey, every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-semibold text-center mb-10">Our team member</h2>
