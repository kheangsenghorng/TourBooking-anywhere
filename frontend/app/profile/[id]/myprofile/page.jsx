...
const page = () => {
  ...
  return (
    ...
    <div className="flex flex-col items-center mb-8">
      ...
      <Link
          href={`/profile/${id}/editMyProfile`}>
      <button className="mt-4 flex items-center bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-full">
    ...
    <div className="bg-white rounded-lg shadow-md p-6 mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          <label className="block text-sm text-gray-600 mb-1">Home Number</label>
    ...
    <div className="flex justify-end">
      <button className="bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-6 rounded">Create</button>
    </div>
  </div>  
  )
}
