        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            ...
            <div className="flex flex-col items-center justify-center rounded-lg border p-4 text-center">
              ...
              <span className="text-xs text-muted-foreground">
                {getTourDuration(tour.startDate, tour.endDate)}
              </span>
            </div>
            <div className="flex flex-col items-center justify-center rounded-lg border p-4 text-center">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    ...
                    {getTourDuration(tour.startDate, tour.endDate)} tour
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <Suspense fallback={<div>Loading itinerary...</div>}>
                    <TourItinerary tourId={tour.tourId} />
                  </Suspense>
                </CardContent>
              </Card>
            </TabsContent>
                ...
                <CardContent className="space-y-4">
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Central Station, 8:00 AM
                      </p>
                    </div>
                    <div className="space-y-1">
                      <h4 className="text-sm font-medium">Tour Guide</h4>
                      <p className="text-sm text-muted-foreground">
                        John Smith (Contact: +1234567890)
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="rounded-md bg-muted p-4">
                    ...
                    <ul className="space-y-2 text-sm">
                      ...
                      <li>
                        Bring comfortable walking shoes and weather-appropriate
                        clothing.
                      </li>
                      <li>
                        Don't forget your camera, water bottle, and any personal
                        medications.
                      </li>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="border-t pt-4">
                <div className="flex justify-between font-bold">
                  ...
                  <span>
                    $
                    {tour.price * tour.guests +
                      Math.round(tour.price * tour.guests * 0.1)}
                  </span>
                </div>
              </div>
            </CardContent>
