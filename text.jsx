...
//     }
//   }, [params.tourId, fetchItinerariesByTourId]);
...
//         Error fetching itineraries: {itinerariesError}
//       </div>
//     );
//   }
//   const TourEndInfo = () => (
...
//               {Math.round(
//                 (itineraries.filter((itinerarie) => itineraries.isCompleted).length /
//                   itineraries.length) *
//                   100
//               )}
//               % Complete
...
//                   style={{
//                     width: `${Math.round(
//                       (itineraries.filter((item) => item.isCompleted).length /
//                       itineraries.length) *
//                         100
//                     )}%`,
//                   }}
...
//           {Math.round(
//             (itineraryData.filter((item) => item.isCompleted).length /
...
//                       style={{
//                         width: `${Math.round(
//                           (itineraryData.filter((item) => item.isCompleted)
//                             .length /
//                             itineraryData.length) *
//                             100
//                         )}%`,
